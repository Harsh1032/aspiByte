      ...
      <div className='flex w-full'>
        <div className='w-[70%] h-[905px] overflow-y-scroll no-scrollbar' style = {{background: selectedTheme.colors.sixth}}>
            <div className='ml-auto flex w-[200px] mt-2'>
                <Link to='/game1'><p className='font-normal text-base' style = {{color: selectedTheme.colors.secondary}}>feeling stressed?</p></Link>
            </div>
            ...
            <div className='grid grid-cols-2 gap-4 place-items-center w-full mt-5 h-[800px]'>
                <Link to='/subject'><div className='w-[400px] h-[250px] flex flex-col py-3 mr-5'>
                    ...
                    <div className='w-full h-[50%] rounded-b-md px-2 py-1' style = {{background: selectedTheme.colors.seventh}}>
                        <h1 className='font-semibold text-xl w-[250px] text-[#1F1F1F] pl-2'>Artificial Intelligence in Health Care</h1>
                    </div>
                </div></Link>
                <div className='w-[400px] h-[250px] flex flex-col py-3'>
                    <img className='w-full h-[50%] rounded-t-md' src={BigData}/>
                    <div className='w-full h-[50%] rounded-b-md px-2 py-1'  style = {{background: selectedTheme.colors.seventh}}>
                        <h1 className='font-semibold text-xl w-[250px] text-[#1F1F1F] pl-2'>Introduction to SQL</h1>
                    </div>
                </div>
                <div className='w-[400px] h-[250px] flex flex-col py-3 mr-5'>
                    <img className='w-full h-[50%] rounded-t-md' src={AI}/>
                    <div className='w-full h-[50%] rounded-b-md px-2 py-1'  style = {{background: selectedTheme.colors.seventh}}>
                        <h1 className='font-semibold text-xl w-[250px] text-[#1F1F1F] pl-2'>Artificial Intelligence in Health Care</h1>
                    </div>
